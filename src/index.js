...
var MobiledocMarkdownRenderer = require("@maartenbusstra/mobiledoc-markdown-renderer")
  .default;
var app = express();
...
app.get("/", function(req, res) {
  ...
  `;
  res.send(result);
  console.log("Received GET", result);
});

// This route processes GET requests to "/"`
app.get("/get-markdown", function(req, res) {
  var renderer = new MobiledocMarkdownRenderer({ cards: [] });
  const rendered = renderer.render(require("../mocks/mobiledoc.json"));
